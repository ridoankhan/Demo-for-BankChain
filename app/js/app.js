...
window.App = {
    ...
    setPersonInfo: function() {
        ...
        var fullName = document.getElementById('fullNameIDTd').innerHTML + " | ";
        ...
        var info = customerNumber + fullName + phone + email + tinNo + nidNo + passportNo + acc + accTitle + accType + openDate + curreny + Balance + BalanceInWord;
        console.log(info);
        var bankStatement;
